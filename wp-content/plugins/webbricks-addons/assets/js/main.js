...
jQuery(window).on("elementor/frontend/init", function () {
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-about-widget.default",
    function ($scope, $) {
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-blog-carousel-widget.default",
    function ($scope, $) {
      ...
      var blog_autoplay_animation = blog_carousel.attr(
        "blog-autoplay-animation"
      );
  ...
  // Counter Widget
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-counter-widget.default",
    function ($scope, $) {
  ...
  // FAQ Widget
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-faq-widget.default",
    function ($scope, $) {
  ...
  // Testimonial Widget
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-testimonial-widget.default",
    function ($scope, $) {
      ...
      var testimonial_autoplay = testimonial_widget.attr(
        "testimonial-autoplay"
      );
      var testimonial_pause = testimonial_widget.attr("testimonial-pause");
      var testimonial_autoplay_speed = testimonial_widget.attr(
        "testimonial-autoplay-speed"
      );
      var testimonial_autoplay_animation = testimonial_widget.attr(
        "testimonial-autoplay-animation"
      );
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-team-carousel-widget.default",
    function ($scope, $) {
      ...
      var team_autoplay_animation = team_carousel.attr(
        "team-autoplay-animation"
      );
  ...
  // Slider Widget
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-slider-widget.default",
    function ($scope, $) {
  ...
  // Services Widget
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-services-widget.default",
    function ($scope, $) {
      ...
      var services_autoplay_speed = service_widget.attr(
        "services-autoplay-speed"
      );
      var services_autoplay_animation = service_widget.attr(
        "services-autoplay-animation"
      );
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-products-category-carousel-widget.default",
    function ($scope, $) {
      var product_category_carousel = $scope.find(".product-category-carousel");
      var product_category_carousel_items = product_category_carousel.attr(
        "product-category-carousel-items"
      );
      var product_category_carousel_arrows = product_category_carousel.attr(
        "product-category-carousel-arrows"
      );
      var product_category_carousel_loops = product_category_carousel.attr(
        "product-category-carousel-loops"
      );
      var product_category_carousel_pause = product_category_carousel.attr(
        "product-category-carousel-pause"
      );
      var product_category_carousel_autoplay = product_category_carousel.attr(
        "product-category-carousel-autoplay"
      );
      var product_category_carousel_autoplay_speed =
        product_category_carousel.attr(
          "product-category-carousel-autoplay-speed"
        );
      var product_category_carousel_autoplay_animation =
        product_category_carousel.attr(
          "product-category-carousel-autoplay-animation"
        );
      ...
      function setEqualHeight() {
        ...
        $(".product-category-carousel .product-category").css("height", "auto");

        // Loop through each product-category item to find the tallest one
        $(".product-category-carousel .product-category").each(function () {
        ...
        $(".product-category-carousel .product-category").css(
          "height",
          maxItemHeight
        );
      }
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-products-carousel-widget.default",
    function ($scope, $) {
      ...
      function equalizeProductHeightsByRow(event) {
        ...
        $products.each(function () {
          ...
          rowHeights[productTop] = Math.max(
            rowHeights[productTop],
            $product.outerHeight()
          );
        });
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/webbricks-filter-gallery-widget.default",
    function ($scope, $) {
